...
import { clearActiveTenant, clearSession, setActiveTenant, setAuthSession } from "./sessionSlice";

export const sessionPersistListener = createListenerMiddleware();

sessionPersistListener.startListening({
  matcher: isAnyOf(setAuthSession, setActiveTenant, clearActiveTenant, clearSession),
