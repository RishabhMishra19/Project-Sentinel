...
export class ServicesApi {
  static listAll(query: ListQueryRequest): Promise<PageResponse<ServiceResponse>> {
    return apiManager.post<PageResponse<ServiceResponse>>(SERVICES_API_ROUTES.SEARCH_ALL, query);
  }

  static list(productId: string, query: ListQueryRequest): Promise<PageResponse<ServiceResponse>> {
  ...
  static create(productId: string, payload: CreateServiceRequest): Promise<ServiceResponse> {
    return apiManager.post<ServiceResponse>(SERVICES_API_ROUTES.LIST(productId), payload);
  }
  ...
  static update(
    ...
    return apiManager.put<ServiceResponse>(SERVICES_API_ROUTES.BY_ID(productId, id), payload);
  }
