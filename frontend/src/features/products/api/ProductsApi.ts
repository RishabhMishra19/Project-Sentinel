...
export class ProductsApi {
  static list(query: ListQueryRequest): Promise<PageResponse<ProductResponse>> {
    return apiManager.post<PageResponse<ProductResponse>>(PRODUCTS_API_ROUTES.SEARCH, query);
  }
