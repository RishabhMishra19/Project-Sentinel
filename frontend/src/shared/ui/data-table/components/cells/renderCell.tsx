...
export const renderCell = <T extends object>(cell: DataTableCellConfig<T>, row: T): ReactNode => {
  switch (cell.type) {
    case "text":
    ...
    case "badge":
      return <BadgeCell value={cell.getValue(row)} labels={cell.labels} variants={cell.variants} />;
    case "custom":
