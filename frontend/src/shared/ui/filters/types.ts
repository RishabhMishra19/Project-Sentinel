export type FilterType =
  "select" | "multiSelect" | "boolean" | "date" | "dateRange" | "dateTimeRange";
...
export type FilterValue<F extends FilterType = FilterType> = FilterValueByType[F];

export type FilterFieldConfig<F extends FilterType = FilterType> = FilterConfigByType[F];
