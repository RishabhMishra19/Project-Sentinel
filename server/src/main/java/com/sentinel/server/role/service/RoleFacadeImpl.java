package com.sentinel.server.role.service;
...
import com.sentinel.server.role.service.core.RoleScopeService;
import com.sentinel.server.role.service.core.RoleService;
...
public class RoleFacadeImpl implements RoleFacade {
    ...
    private void validateResourceScope(UUID tenantId, RoleScopeType scopeType, UUID scopeId) {
        ...
        if (scopeType == RoleScopeType.SERVICE) {
            com.sentinel.server.service.entity.Service service = serviceService
                    .findWithAuditById(scopeId)
