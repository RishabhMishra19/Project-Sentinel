...
@Setter
@NoArgsConstructor
public class AnalyticsTenantStatsHour extends AnalyticsStatsMetrics {

    public AnalyticsTenantStatsHour(AnalyticsStatsMetrics statsMetrics, UUID tenantId, Instant bucketStart) {
        super(statsMetrics);
