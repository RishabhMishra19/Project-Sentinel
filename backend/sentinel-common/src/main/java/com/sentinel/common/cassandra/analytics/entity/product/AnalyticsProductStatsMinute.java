...
@Table("analytics_product_stats_minute")
@Getter
@Setter
@NoArgsConstructor
public class AnalyticsProductStatsMinute extends AnalyticsStatsBase {

    @PrimaryKey
    private PrimaryKeyComposite id;

    public AnalyticsProductStatsMinute(KafkaMessage.AnalyticsMetrics statsMetrics, UUID productId, Instant bucketStart) {
        super(statsMetrics);
