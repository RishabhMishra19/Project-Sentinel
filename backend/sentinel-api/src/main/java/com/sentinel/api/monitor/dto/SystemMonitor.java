...
public final class SystemMonitor {
    ...
    public static record ServiceResponse(String serviceName, String status, CPU cpu, Memory memory, Threads threads,
                                         HTTPRequest httpRequest, GC gc, Disk disk, DBConnection dbConnection) {
    }
