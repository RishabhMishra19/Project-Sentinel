...
public final class AnalyticsStreamTestUtils {
     ...
     *
     * inputBucket  = bucket of the records being fed into the topology.
     * windowBucket = bucket of the aggregation being tested.
     *
     * Example:
     * endpoint minute -> endpoint hour:
     * inputBucket = MINUTE, windowBucket = HOUR
     */
    ...
    public static Instant truncateTimestamp(
        ...
        return switch (bucket) {
            ...
            case DAY ->
                    timestamp.truncatedTo(ChronoUnit.DAYS);
        };
    }
